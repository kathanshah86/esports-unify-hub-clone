...
const TournamentRegistrationComponent: React.FC<TournamentRegistrationProps> = ({ tournament }) => {
  ...
  const handleRegistrationSubmit = async (data: { gameId: string; customFields: Record<string, string>; screenshotUrl?: string; paidViaWallet?: boolean; referralCode?: string; referrerUserId?: string; discountedAmount?: number }) => {
    setIsLoading(true);
    setShowRegistrationDialog(false);

    const finalAmount = typeof data.discountedAmount === 'number' ? data.discountedAmount : entryFeeAmount;
  ...
  return (
    <div className="space-y-6">
      ...
      <RegistrationFormDialog
        ...
        referralEnabled={!!tournament.referral_enabled}
        referralDiscountPercent={tournament.referral_discount_percent || 0}
      />
