              ...
              <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
                ...
                <Card className="bg-gray-800/50 border-gray-700 hover:border-purple-500/50 transition-all duration-300">
                  ...
                  <CardContent className="space-y-4">
                    ...
                    {/* Battle Code (Referral) */}
                    <div className="border-t border-gray-700 pt-4">
                      <div className="flex items-center gap-2 mb-2">
                        <Ticket className="w-4 h-4 text-amber-400" />
                        <p className="text-xs text-amber-400 uppercase tracking-wide font-semibold">Your Battle Code</p>
                      </div>
                      <div className="flex items-center gap-2 bg-gradient-to-r from-amber-500/10 to-orange-500/10 border border-amber-500/30 rounded-xl p-3">
                        <code className="flex-1 text-amber-200 font-mono text-lg font-bold tracking-widest text-center">
                        ...
                        <Button
                          ...
                          onClick={async () => {
                            ...
                            const shareText = `Use my Battle Code "${profile.referral_code}" to get a discount on your next tournament entry fee!`;
                            if (navigator.share) {
                              try {
                                await navigator.share({ title: 'My Battle Code', text: shareText });
                              } catch {}
                            } else {
                      ...
                      <p className="text-xs text-gray-400 mt-2">
                        Share this code with friends. When they use it at tournament registration, they get a discount on the entry fee.
                      </p>
                    </div>
